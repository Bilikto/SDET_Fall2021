...
public class TernaryOperator {
    public static void main(String[] args) {
        ...
        int res;
        res = (x > y) ? x : y;
        // the value that res variable will get assigned
        // depends on the outcome of the expression
        // if x is greater than y, then x will be the value assigned to res
        // otherwise if x is not greater than y, then y will get assigned to res
