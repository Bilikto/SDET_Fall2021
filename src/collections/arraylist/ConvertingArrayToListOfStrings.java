...
public class ConvertingArrayToListOfStrings {
    ...
    public static void main(String[] args) {
        ...
        animalsList.set(1, "White sharks");
        //changes affected on both array and arrayList
        System.out.println("After replacing array: " + Arrays.toString(animalsArray));
        System.out.println("After replacing list: " + animalsList);
